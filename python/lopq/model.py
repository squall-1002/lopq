...
def train(data, V=8, M=4, subquantizer_clusters=256, parameters=None,
          ...
          subquantizer_sample_ratio=1.0, random_state=None, verbose=False, n_jobs=1):
    """
    Fit an LOPQ model.
    ...
    if Cs is not None:
        ...
        C1 = train_coarse(first_half, V, kmeans_coarse_iters, n_init, random_state, n_jobs=n_jobs)
        C2 = train_coarse(second_half, V, kmeans_coarse_iters, n_init, random_state, n_jobs=n_jobs)
...
class LOPQModel(object):
    ...
    def fit(self, data, kmeans_coarse_iters=10, kmeans_local_iters=20, n_init=10, subquantizer_sample_ratio=1.0, random_state=None, verbose=False, n_jobs=1):
        ...
        parameters = train(data, self.V, self.M, self.subquantizer_clusters, existing_parameters,
                           ...
                           random_state, verbose, n_jobs=n_jobs)
